...
def load_acoustic(checkpoint_path):
    acoustic = AcousticModel()
    checkpoint_dict = torch.load(checkpoint_path)
    consume_prefix_in_state_dict_if_present(checkpoint_dict["acoustic-model"], "module.")
    acoustic.load_state_dict(checkpoint_dict["acoustic-model"])
    acoustic.eval()
